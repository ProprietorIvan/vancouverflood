...
const DryingAndDehumidification = () => {
  ...
  const emergencyBenefits = [
    {
      ...
      description: "Emergency service throughout Burnaby and surrounding areas",
    },
    {
  ...
  const serviceFeatures = [
    {
      ...
      description:
        "Strategic placement of professional air movers ensures maximum airflow and accelerated evaporation in Burnaby&apos;s humid climate.",
    },
    {
      icon: <Droplets className="w-6 h-6" />,
      title: "LGR Dehumidifiers",
      description:
        "Our low-grain refrigerant dehumidifiers extract moisture from materials and air, perfect for Burnaby&apos;s wet conditions.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Temperature and humidity management for optimal drying conditions, especially important in Burnaby&apos;s climate.",
    },
  ];
  ...
  const schema = {
    ...
    "@type": "Service",
    name: "Structural Drying & Dehumidification Burnaby",
    provider: {
      "@type": "LocalBusiness",
      name: "Burnaby Flood Restoration by Felicita Holdings",
      telephone: "+17786546742",
      email: "office@burnabyflood.com",
      address: {
        "@type": "PostalAddress",
    ...
    description:
      "Professional structural drying and dehumidification services in Burnaby. 24/7 emergency response with commercial-grade equipment.",
    ...
    mainEntity: [
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Most standard structural drying projects in Burnaby take between 3-5 days, depending on the extent of water damage, the materials affected, and current weather conditions. Our industrial equipment accelerates this process significantly compared to consumer-grade solutions.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Professional dehumidification is essential because excess moisture that isn't properly removed can lead to mold growth within 24-48 hours, structural damage, and health issues. Burnaby's humidity makes professional-grade equipment particularly important for complete drying.",
        },
      },
      {
        "@type": "Question",
  ...
  return (
    <>
      <Head>
        <title>
          Structural Drying & Dehumidification Burnaby | Professional Water
          Damage Services
        </title>
        <meta
          name="description"
          content="Professional structural drying & dehumidification in Burnaby. Commercial-grade equipment and experienced technicians. Available 24/7 for emergencies."
        />
        <meta
          name="keywords"
          content="structural drying burnaby, dehumidification services burnaby, water damage drying, professional moisture removal, commercial dehumidifiers burnaby, flood drying services"
        />

        {/* Open Graph */}
        <meta
          property="og:title"
          content="Structural Drying & Dehumidification Services Burnaby"
        />
        <meta
          property="og:description"
          content="Professional structural drying services in Burnaby. Commercial-grade equipment and experienced technicians. Available 24/7."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://burnabyflood.com/drying-and-dehumidification"
        />
        <meta
          property="og:image"
          content="https://burnabyflood.com/photos/homepage/8.jpg"
        />
        ...
        <link
          rel="canonical"
          href="https://burnabyflood.com/drying-and-dehumidification"
        />
      ...
      <div className="min-h-screen bg-[#F5F4F0]">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center py-16">
              <div>
                ...
                <p className="text-xl text-[#44403C] mb-8 leading-relaxed">
                  Fast, effective structural drying services throughout Burnaby.
                  Our professional-grade equipment and trained technicians
                  restore your property quickly after water damage.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                  ...
                  <button
                    onClick={() =>
                      copyToClipboard("office@burnabyflood.com", false)
                    }
              ...
              <div className="relative">
                <div className="relative h-[600px] w-full">
                  <Image
                    ...
                    alt="Professional Structural Drying Equipment Burnaby"
                    fill
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold mb-4 text-[#1C1917]">
                Our Burnaby Drying Process
              </h2>
              <p className="text-lg text-[#44403C]">
                Comprehensive structural drying solutions for Burnaby&apos;s
                climate
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-[#44403C]">
                  Most standard structural drying projects in Burnaby take
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm">
                ...
                <p className="text-[#44403C]">
                  ...
                  moisture that isnt properly removed can lead to mold growth
                  within 24-48 hours, structural damage, and health issues.
                  Burnaby&apos;s humidity makes professional-grade equipment
                  particularly important for complete drying.
                </p>
              </div>
        ...
        <section className="py-20 bg-gradient-to-br from-[#8B2635] to-[#7A2230] text-white">
          <div className="max-w-5xl mx-auto px-4 text-center">
            <h2 className="text-4xl font-bold mb-6">
              Burnaby&apos;s Trusted Structural Drying Experts
            </h2>
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Fast, effective water damage restoration across Burnaby. Our 24/7
              emergency response team is ready to help.
            </p>
